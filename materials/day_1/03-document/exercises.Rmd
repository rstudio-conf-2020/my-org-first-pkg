...
6. run `document()` or press `Ctrl/Cmd + Shift + D`. Read the help page for your function with `?theme_avalanche`. You may need to re-build or re-load the package, as well.
...
5. Rebuild the documentation and your package, then check the help page for `?theme_avalanche()`.
...
3. Re-render the documentation and your package, then read the help page for `?theme_avalanche_h()`
