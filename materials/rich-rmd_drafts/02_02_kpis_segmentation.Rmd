...
Create a function that segments either the `daily_users`, the `users`, or the `revenue` table.

Augment one or two the functions created earlier to take advantage of the segmentation functionality.
