...
How much do you want to know about designing functions that standardize plots for reporting needs?

```{r}
# Scale from 1 to 10
standardized_plots <- 5
```

How much do you want to know about package testing and overall package quality?
